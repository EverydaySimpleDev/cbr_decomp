...
//8006D850
extern "C" void ResetCameraData(void* obj)
{
    DispatchFn func1 = *(DispatchFn*)(*(char**)((char*)obj + 0x30) + 0xc);
    func1(obj);

    DispatchFn func2 = *(DispatchFn*)(*(char**)((char*)obj + 0x64) + 0xc);
    func2((char*)obj + 0x34);
    ...
    Vec3 t1 = *(Vec3*)((char*)lbl_802015B0 + 0x48);
    F32(obj, 0x128) = t1.x;
    F32(obj, 0x12c) = t1.y;
    F32(obj, 0x130) = t1.z;
    ...
    Vec3 t2 = *(Vec3*)((char*)lbl_802015B0 + 0x54);
    F32(obj, 0x170) = t2.x;
    F32(obj, 0x174) = t2.y;
    F32(obj, 0x178) = t2.z;
    ...
    Vec3 t3 = *(Vec3*)((char*)lbl_802015B0 + 0x60);
    F32(obj, 0x190) = t3.x;
    F32(obj, 0x194) = t3.y;
    F32(obj, 0x198) = t3.z;
    ...
    Vec3 t4 = *(Vec3*)((char*)lbl_802015B0 + 0x6c);
    F32(obj, 0x1a8) = t4.x;
    F32(obj, 0x1ac) = t4.y;
    F32(obj, 0x1b0) = t4.z;

...
//8016F978
ASM BOOL DVDReadAbsAsyncForBS(register DVDCommandBlock* block, register void* addr, register s32 length, register s32 offset, register DVDCBCallback callback)
{
    nofralloc
    mflr    r0
    stw     r0, 0x4(r1)
